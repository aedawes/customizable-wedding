        ...
        <v-row justify="center">
            <v-col cols="12" sm="8" md="6">
                <v-card elevation="5" class="card" id="content">
                    <v-btn id="back" @click="backbutton()" text justify="left"><v-icon>mdi-arrow-left-circle</v-icon></v-btn>
                    ...
                    <v-card-text justify="center">
                        ...
                        <v-text-field class="input" v-model="loginForm.passConf" type="password" label="Confirm Password" required />
