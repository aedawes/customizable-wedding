    ...
    <v-row justify="center" align="center">
      <v-col cols="12" sm="8" md="6" id="colmn">
        <v-card elevation="5" class="card">
            <v-card-title align="center"> Make Changes to Your Account </v-card-title>
            <v-card-text justify="center">
                ...
                <v-btn class="buttons" style="background-color: red;" @click="deleteAccount()">Delete Account</v-btn>
            </v-card-text>
        </v-card>
      </v-col>
    </v-row>
