  ...
  <v-app light class="mainbody">
    ...
    >
      <v-list id="list">
        ...
        <v-list-item v-if="users !== null" @click.native="updateSite()">
          <v-list-item-action>
          </v-list-item-action>
          <v-list-item-title>Update Site</v-list-item-title>
        </v-list-item>
        <v-list-item v-if="users !== null" @click.native="guestList()">
          <v-list-item-action>
          </v-list-item-action>
          <v-list-item-title>Guest List</v-list-item-title>
        </v-list-item>
