            ...
            <v-col cols="12" sm="8" md="6">
                <v-card elevation="5" class="card" id="content">
                    ...
                    <v-card-text justify="center">
                        ...
                        <v-text-field id="reg" class="input" v-model="form.addRegistryLink" label="https://www.registry.com" required />
                        <div class="centerbtn">
...
export default {
  ...
  methods:{
    async updateForm(){
        // if(this.form.coupleName !== ''){
        //     let name = this.form.coupleName
        // }
